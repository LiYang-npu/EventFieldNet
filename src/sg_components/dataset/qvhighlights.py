...
from sg_components.dataset.utils import (
    add_padding,
    get_qv_hard_indices,
    get_qv_pos_neg_indices,
    initialize_qv_score_array,
)
from sg_components.utils.rw_utils import load_jsonl
from sg_components.utils.span_utils import span_xx_to_cxw
from sg_components.utils.tensor_utils import l2_normalize_np_array, l2_normalize_tensor
...
class QVHighlights(Dataset):  # noqa: WPS230,WPS214
    ...
    def __init__(  # noqa: WPS211
        ...
        self.max_query_length = (
            max_query_length if max_query_length > 0 else MAX_QUERY_LENGTH
        )
        self.max_video_length = (
            max_video_length if max_video_length > 0 else MAX_VIDEO_LENGTH
        )
    ...
    def add_fpn_padding(
        self, video_emb: Tensor, audio_emb: Optional[Tensor]
    ...
    def get_saliency_labels_all(
        ...
        score_array = initialize_qv_score_array(
            relevant_clip_ids, number_of_clips, agg_scores
        )
