"""R48 explicitly named independent experiments, reconstructed identically by evaluation."""
...
from .model.selector import Round31FieldScoreHeads
...
class R48Selector(Round31FieldScoreHeads):
...
class R48Model(adapter.TriFieldRound31Model):
